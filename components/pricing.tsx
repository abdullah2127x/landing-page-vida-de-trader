...
export default function Pricing() {
  return (
    <section
      id="pricing"
      className="relative py-24 lg:py-32 overflow-hidden flex items-center justify-center min-h-screen"
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 lg:px-8 w-full">
        ...
        <div className="text-center space-y-4 mb-16">
          <p className="text-sm font-semibold uppercase tracking-widest text-gold text-shadow-sm">
            Investimento
          </p>
          <h2 className="text-3xl font-extrabold uppercase text-white sm:text-4xl lg:text-5xl drop-shadow-lg">
        ...
        <div className="mx-auto max-w-lg lg:max-w-xl">
          <div className="relative overflow-hidden rounded-3xl border border-gold/20 bg-midnight/80 backdrop-blur-xs shadow-[0_0_50px_rgba(234,179,8,0.15)] flex flex-col p-8 sm:p-12 text-center">
            ...
            <div className="space-y-10">
              ...
              <div className="space-y-3">
                <p className="text-xl text-slate-300 font-medium tracking-wide">
                  De{" "}
                  <span className="line-through text-slate-500">R$ 499,00</span>{" "}
                  por apenas
                </p>
              ...
              <div className="pt-4 space-y-4">
                <Button
                  asChild
                  size="lg"
                  className="w-full bg-gold hover:bg-yellow-500 text-midnight font-bold uppercase tracking-wider text-xl py-8 rounded-xl group transition-all"
                >
                  <a href="#pricing">
