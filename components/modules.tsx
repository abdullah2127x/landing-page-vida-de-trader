...
export default function Modules() {
  return (
    <section
      id="modules"
      className="relative py-24 lg:py-32 bg-blue-low bg-section-gradient"
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        />
        <p className="-mt-12 mb-16 mx-auto max-w-2xl text-lg text-white-muted text-center">
          Cada módulo foi cuidadosamente elaborado para construir sua base de
          conhecimento de forma progressiva e prática.
        </p>

        {/* Course Descriptions */}
        <div className="mx-auto space-y-8 mb-16 text-left">
          <div className="space-y-3">
            ...
            <p className="text-sm md:text-base text-white font-medium leading-relaxed">
              <span className="text-white-muted font-bold">PT-BR |</span>{" "}
              Emerson Somenzari se destaca como trader, conhecido por sua
              habilidade em ensinar a estratégia Smart Money de forma clara e
              acessível. Com amplo conhecimento do mercado financeiro, ele é
              reconhecido como uma autoridade nesse campo.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm md:text-base text-white font-medium leading-relaxed">
              <span className="text-gold font-bold">EN |</span> Emerson
              Somenzari excels as a trader, renowned for his clear and
              accessible instruction on the Smart Money strategy. With deep
              expertise in the financial market, he's widely acknowledged as a
              top authority in this field.
            </p>
          </div>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {modules.map((mod, i) => (
            <Card
              key={mod.number}
              className="group relative overflow-hidden border-gold/15 bg-blue-dark cursor-default hover:border-gold/40 transition-all duration-300"
              style={{ animationDelay: `${i * 80}ms` }}
            >
              {/* Module number watermark */}
              <span className="absolute top-4 right-4 text-6xl font-black text-gold/6 select-none">
                {mod.number}
              </span>
              ...
              {/* Bottom gold accent */}
              <div className="absolute bottom-0 left-0 right-0 h-px bg-linear-to-r from-transparent via-gold/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity" />
            </Card>
          ))}
        </div>
      </div>
