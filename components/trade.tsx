...
export default function Trade() {
  return (
    <section id="trade" className="relative py-24 lg:py-32 overflow-hidden bg-[#01030a]">
      {/* Background container restricted to the left side */}
      <div className="absolute inset-y-0 left-0 w-full lg:w-[55%]">
        {/* Deep blue background base for the left side */}
        ...
        {/* Gradient fade to merge smoothly into the right side's dark background */}
        ...
        <div className="grid gap-12 lg:grid-cols-2 flex-col-reverse lg:flex-row items-center">
          ...
          <div className="space-y-8 max-w-xl text-left">
            <h2 className="text-2xl sm:text-3xl font-normal tracking-wide text-white uppercase">
              O QUE É O <span className="text-gold font-bold">TREINAMENTO SMD?</span>
            </h2>
            
            <div className="space-y-6 text-sm sm:text-base text-slate-300 leading-relaxed font-light">
              <p>
                No <span className="text-gold font-semibold">Treinamento Smart Money Descomplicado</span>, 
                você vai aprender as estratégias dos investidores institucionais, permitindo que você {" "}
              ...
              <p>
                Seja parte de uma comunidade exclusiva que domina o mercado financeiro, {" "}
                <span className="text-gold font-semibold">
                  maximizando lucros e minimizando riscos
                </span>. Não perca a 
                chance de transformar sua jornada e alcançar tão sonhada consistência. Junte-se a nós e 
                comece sua jornada rumo ao topo do mundo financeiro hoje mesmo!
              </p>
            </div>
          </div>
