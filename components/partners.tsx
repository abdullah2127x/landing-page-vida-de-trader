export default function Partners() {
  return (
    <section
      id="partners"
      className="relative w-full py-20 bg-[#01030a] flex items-center justify-center overflow-hidden"
    >
      <div className="mx-auto max-w-4xl w-full px-6">
        {/* Bordered Box */}
        <div className="rounded-2xl border border-gold/20 bg-[#050816]/60 backdrop-blur-sm py-12 sm:py-16 px-8 flex flex-col items-center justify-center shadow-[0_0_30px_rgba(234,179,8,0.05)]">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-16 sm:gap-24 lg:gap-32 w-full">
            ...
            <div className="flex items-center gap-3 opacity-90 hover:opacity-100 transition-opacity grayscale hover:grayscale-0">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-slate-400 text-[9px] tracking-widest font-light italic leading-none">
            ...
            <div className="opacity-90 hover:opacity-100 transition-opacity grayscale hover:grayscale-0">
              <span className="text-[#FF4500] text-2xl font-bold tracking-[0.1em]">
